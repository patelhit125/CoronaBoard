...
export function theme(customization) {
    let textPrimary, textSecondary, textDark, textHint, background, paper, secondary, menuCaption, textInversePrimary, primary, success, error, warning;

    switch (customization.themeType) {
        case 'dark':
            ...
            success = value.successLight;
            error = value.errorLight;
            warning = value.warningLight;
            break;
        case 'light':
        default:
    ...
    return createMuiTheme({
        direction: customization.direction ? 'rtl' : 'ltr',
        palette: {
            type: 'light',
            common: {
